...
class Plugin {
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cloning is forbidden.', 'verify-woo' ), '1.0.0' );
	}
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Unserializing instances of this class is forbidden.', 'verify-woo' ), '1.0.0' );
	}
	...
	private function define_constants() {
		$this->define( 'PLUGIN_VERSION', '1.0.0' );
		$this->define( 'PLUGIN_NAME', 'VerifyWoo' );
		$this->define( 'PLUGIN_CONTEXT', 'VerifyWoo' );
		$this->define( 'PLUGIN_DIR', untrailingslashit( plugin_dir_path( __DIR__ ) ) );
		$this->define( 'PLUGIN_URL', untrailingslashit( plugin_dir_url( __DIR__ ) ) );

		if ( defined( 'WP_CLI' ) && WP_CLI ) {
			$this->define( 'PLUGIN_CLI', true );
		}
	}
	...
	private function load_dependencies() {
		if ( defined( 'PLUGIN_CLI' ) && PLUGIN_CLI ) {
			new \app\CLI();
		}
